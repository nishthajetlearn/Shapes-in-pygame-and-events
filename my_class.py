...
yellow = (255,255,0)
black=(0,0,0)
# __init__ method initializes the circle with:
# color: the color of the circle.
# pos: the position (x, y) of the circle on the screen.
# radius: the radius of the circle.
# width: the width of the circle's outline (0 means a filled circle).
screen.fill(white)
